...
export function EventForm({ onSubmit, categories, organizers, tags  }) {
  ...
  return (
    <Card className="mx-auto max-w-4xl border-border/70 shadow-sm">
      <CardHeader className="space-y-1">
        ...
        <CardDescription>
          Complete la información principal. En la próxima clase estos datos se
          enviarán a la API.
        </CardDescription>
      </CardHeader>
      ...
      <form onSubmit={handleSubmit(handleValidSubmit)}>
        <CardContent className="grid gap-6">
          <div className="grid gap-5 md:grid-cols-2">
            ...
            <div>
              ...
              <Controller
                ...
                render={({ field }) => (
                  ...
                  >
                    <SelectTrigger
                      className={errors.organizerId ? "border-destructive" : ""}
                    >
            ...
            <div className="md:col-span-2">
              ...
              <div
                className={`grid gap-4 rounded-xl border border-dashed bg-muted/30 p-4 transition-colors md:grid-cols-[220px_1fr] ${
                  errors.imageUrl ? "border-destructive" : "border-border hover:border-primary/60"
                }`}
              >
                ...
                <div className="flex flex-col justify-center gap-3">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-muted-foreground">
                      En esta clase solo se selecciona el archivo. La vista previa
                      real y la carga al servidor se implementarán después.
                    </p>
                    <p className="text-xs text-muted-foreground">
        ...
        <CardFooter className="flex flex-col-reverse gap-3 border-t pt-6 sm:flex-row sm:justify-end">
          <Button type="button" variant="outline" onClick={() => { reset(); setImagePreview(null); }}>
            Limpiar
          </Button>
